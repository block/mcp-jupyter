...
const config: Config = {
  ...
  organizationName: 'squareup', // Usually your GitHub org/user name.
    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl:
            'https://github.com/squareup/mcp-jupyter/tree/main/docs/',
        },
        blog: false,
        theme: {
  ...
  themeConfig: {
    ...
    navbar: {
      ...
      items: [
        ...
        {
          href: 'https://github.com/squareup/mcp-jupyter',
          label: 'GitHub',
          position: 'right',
        },
      ],
